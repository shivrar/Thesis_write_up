...
\chapter*{Abstract}
\begin{SingleSpace}
\initial{T}he use of UltraWide Band technology to function as a positioning system in hard environments for localisation has been addressed in this dissertation.The overall goal is to achieve viable position estimates that an indoor drone or robotic system can use while operating in this environment.
