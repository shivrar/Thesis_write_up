...
The pose can be obtained via two modes: 1). A pure Two Way Ranging (TWR) Approach or 2.) A tracking appoach using a Kalman prediction filter in addtion to the TWR pose.
