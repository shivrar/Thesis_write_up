...
Given EKF's use in localisation, an alternative can be developed that can provide position estimates similar to what can be obtained from the FCU.\medskip

The dissertation was split into the following chapters:
\begin{enumerate}
